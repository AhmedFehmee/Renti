...
/**
 * Created by Fehoo on 12/18/2017.
 */

public class CompanyLocation extends AppCompatActivity implements
            ...
            public void onClick(View view) {
                ...
                if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    if (mCenterLatLong != null) {
                        ...
                        Log.i("Address", i.getStringExtra("location") + " ");
                        if (i.getStringExtra("location").equals("profile")) {
                            Intent intent = new Intent(CompanyLocation.this, HomeActivity.class);
                            intent.putExtra("lat", lat);
                            intent.putExtra("lon", lon);
                            intent.putExtra("newLocation", address);
                            setResult(1000,intent);
                            finish();
                        }else{
                            Intent returnIntent = new Intent(CompanyLocation.this, RegisterActivity.class);
                            returnIntent.putExtra("lat", lat);
                            returnIntent.putExtra("lon", lon);
                            returnIntent.putExtra("newLocation", address);
                            returnIntent.putExtra("typeUser", "company");
